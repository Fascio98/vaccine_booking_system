module Admin
  class BusinessUnitsController < ApplicationController
    ...
    def destroy
      ...
      if result.success?
        redirect_to admin_business_units_path, notice: I18n.t('admin.business_units.notices.destroyed')
      end
    end
    ...
    def business_unit_params
      params.require(:business_unit).permit(:id, :name, :code, :active, :country_id, :city_id, :district_id)
    end
  end
end