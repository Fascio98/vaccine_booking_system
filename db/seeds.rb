...
user = User.find_or_initialize_by(full_name:'Nikoloz Bakhtadze',email: 'nbakhtadze@vaba.co')
...
city = City.find_or_create_by(name: 'Tbilisi', code: 'tbilisi', active:true, country_id: country.id)
